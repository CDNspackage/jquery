;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="a1e533f9c34063b71b0a7674e2524fab";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["78FfTnSxvkCm"]={appId:"RVaR_vPwa0_9",scope:{}};;CloudflareApps.installs["78FfTnSxvkCm"].options={"general":{"pages":{"URLPatterns":["^mastrolive.xyz/?.*$","^mastrolive.xyz/?.*$"]}},"message":{"color":"#f8f7f7","content":"\u003cp style=\"text-align: center;\"\u003eWe rely on ad revenue, please consider whitelisting this site. It just takes a second.\u003c/p\u003e"},"mobile":{"runOnMobile":false},"other":{"backgroundColor":"#f5f5f5","cornerRadius":0.022,"overlayColor":"#f8f1f1"},"title":{"color":"#ffffff","content":"\u003ch1 style=\"text-align: center;\"\u003eIt looks like you're using an ad blocker.\u003c/h1\u003e"}};;CloudflareApps.installs["78FfTnSxvkCm"].product={"id":"free"};;CloudflareApps.installs["CSoWXDmhAtVQ"]={appId:"ngqhM7rZolNP",scope:{}};;CloudflareApps.installs["CSoWXDmhAtVQ"].options={"close":false,"colors":{"colorBackground":"#ff0000","colorText":"#ffffff"},"fontSize":50,"once":false,"proColors":false,"proTranslation":false,"style":"block","translation":{"translationRefresh":"I understand, I have disabled my ad blocker.  Let me in!","translationText":"But without advertising-income, we can't keep making this site awesome.","translationTitle":"It looks like you're using an ad blocker."},"warningSize":100};;CloudflareApps.installs["CSoWXDmhAtVQ"].product={"id":"basic"};;CloudflareApps.installs["DFa8cRYUPWhn"]={appId:"0n-Tbk3FbOG8",scope:{}};;CloudflareApps.installs["DFa8cRYUPWhn"].options={};;CloudflareApps.installs["Ojg2pc65GYl0"]={appId:"mt9QUlJFKGSg",scope:{}};;CloudflareApps.installs["Ojg2pc65GYl0"].options={"account":{"accountId":"Sw7AivDA0nxt","service":"jsguardian"},"free":{"guardInnerHTML":"strict","guardInput":"strict","guardPrompt":"strict","guardTransport":"https-only","guardWhen":"before","guardXSS":"sanitize"}};;if(CloudflareApps.matchPage(CloudflareApps.installs['Ojg2pc65GYl0'].URLPatterns)){(function(){"use strict";function cloneObject(obj,done=new Map()){if(done.has(obj)){return done.get(obj);}
...
return"";}
var _addEventListener=window.addEventListener,_setAttribute=Element.prototype.setAttribute,options=cloneObject(typeof(CloudflareApps.installs['Ojg2pc65GYl0'].options)!=="undefined"?CloudflareApps.installs['Ojg2pc65GYl0'].options:{"free":{"guardWhen":"before","guardInnerHTML":"clean","guardPrompt":"clean","guardInput":"clean","guardTransport":"https-only","guardXSS":"sanitize"},"plan":"free"});function isExecutable(str){var functionExp=/([\s\(]*.\(\s*.*\s*\)\s*.*\s*=>)|([\s*.*\s*=>\s*.\{)|([\s\(]*.[Ff]unction\s*.*\s*\(\s*.*\s*\)\s*.*\s*\{)/,templateExp=/(\`(\s*.*)\$\{(\s*.*\s*.*)\}(\s*.*)\`)/;return functionExp.test(str)||templateExp.test(str)};function protect(){if(options.guardInput&&options.guardInput!=="off"){(function(){if(_addEventListener){_addEventListener.call(window,"change",function(event){var target=event.currentTarget;if(target instanceof HTMLInputElement||target instanceof HTMLTextAreaElement){var oldvalue=target.getAttribute("value"),clean=sanitize(target.value);if(oldvalue===clean){return;}
...
if(options.guardWhen==="after"&&_addEventListener){_addEventListener.call(window,"load",protect);}else{protect();}})();}(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/6Vx4TsfJjKX-n5-l4P4Hn_soj-4.js';document.head.appendChild(script);})();
